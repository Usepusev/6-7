...
def main():
    ...
    # list_input - переменная для ввода строки чисел разделенных запятыми list_input
    # list_numbers - переменная с массивом чисел полученным из введёного 
    # min_bound и max_bound - целочисленные переменные границ
